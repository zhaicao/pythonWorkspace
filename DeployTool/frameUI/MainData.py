...
class TraceObjItems(object):
    ...
    def TraceConfItems(self):
        ...
        # 定义工厂定制控件类型和名称对应的字典
        self.nifiConfItem = {
            'nifi_input_1': {'objType': QtWidgets.QLineEdit, 'confItem': 'SqlConnectionPool.host'},
            'nifi_input_2': {'objType': QtWidgets.QLineEdit, 'confItem': 'SqlConnectionPool.port'},
            'nifi_input_3': {'objType': QtWidgets.QLineEdit, 'confItem': 'SqlConnectionPool.user'},
            'nifi_input_4': {'objType': QtWidgets.QLineEdit, 'confItem': 'SqlConnectionPool.pwd'},
            'nifi_input_5': {'objType': QtWidgets.QComboBox, 'confItem': 'SqlConnectionPool.db'},
            'getDBBtn_3': {'objType': QtWidgets.QPushButton},
            'nifi_input_6': {'objType': QtWidgets.QLineEdit, 'confItem': 'BIConnectionPool.host'},
            'nifi_input_7': {'objType': QtWidgets.QLineEdit, 'confItem': 'BIConnectionPool.port'},
            'nifi_input_8': {'objType': QtWidgets.QLineEdit, 'confItem': 'BIConnectionPool.user'},
            'nifi_input_9': {'objType': QtWidgets.QLineEdit, 'confItem': 'BIConnectionPool.pwd'},
            'nifi_input_10': {'objType': QtWidgets.QComboBox, 'confItem': 'BIConnectionPool.db'},
            'getDBBtn_4': {'objType': QtWidgets.QPushButton},
            'nifi_input_11': {'objType': QtWidgets.QCheckBox, 'confItem': 'HistoryConnectionPool.enable'},
            'nifi_input_12': {'objType': QtWidgets.QLineEdit, 'confItem': 'HistoryConnectionPool.host'},
            'nifi_input_13': {'objType': QtWidgets.QLineEdit, 'confItem': 'HistoryConnectionPool.port'},
            'nifi_input_14': {'objType': QtWidgets.QLineEdit, 'confItem': 'HistoryConnectionPool.user'},
            'nifi_input_15': {'objType': QtWidgets.QLineEdit, 'confItem': 'HistoryConnectionPool.pwd'},
            'nifi_input_16': {'objType': QtWidgets.QComboBox, 'confItem': 'HistoryConnectionPool.db'},
            'getDBBtn_5': {'objType': QtWidgets.QPushButton},
            'nifi_input_17': {'objType': QtWidgets.QCheckBox, 'confItem': 'PPConnectionPool.enable'},
            'nifi_input_18': {'objType': QtWidgets.QLineEdit, 'confItem': 'PPConnectionPool.host'},
            'nifi_input_19': {'objType': QtWidgets.QLineEdit, 'confItem': 'PPConnectionPool.port'},
            'nifi_input_20': {'objType': QtWidgets.QLineEdit, 'confItem': 'PPConnectionPool.user'},
            'nifi_input_21': {'objType': QtWidgets.QLineEdit, 'confItem': 'PPConnectionPool.pwd'},
            'nifi_input_22': {'objType': QtWidgets.QComboBox, 'confItem': 'PPConnectionPool.db'},
            'getDBBtn_6': {'objType': QtWidgets.QPushButton},
            'nifi_input_23': {'objType': QtWidgets.QCheckBox, 'confItem': 'nifi.auth'},
            'nifi_input_24': {'objType': QtWidgets.QLineEdit, 'confItem': 'nifi.host'},
            'nifi_input_25': {'objType': QtWidgets.QLineEdit, 'confItem': 'nifi.port'},
            'nifi_input_26': {'objType': QtWidgets.QLineEdit, 'confItem': 'nifi.user'},
            'nifi_input_27': {'objType': QtWidgets.QLineEdit, 'confItem': 'nifi.pwd'},
            'nifi_input_28': {'objType': QtWidgets.QLineEdit, 'confItem': 'nifi.template'},
            'getFile': {'objType': QtWidgets.QPushButton}
        }